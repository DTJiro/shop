...
import com.bamboo.domain.Cart;
import com.bamboo.domain.CartItem;
...
import com.bamboo.service.impl.OrderServiceImpl;
import com.bamboo.utils.PaymentUtil;
	...
	public String callback(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			if (isValid) {
				...
				order.setState(Constant.ORDER_FUKUAN);
